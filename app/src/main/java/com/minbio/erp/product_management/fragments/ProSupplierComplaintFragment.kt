...
import com.minbio.erp.product_management.adapter.ProSupplierComplaintAdapter
import com.minbio.erp.product_management.model.ProSupplierComplaintData
import com.minbio.erp.product_management.model.ProSupplierComplaintModel
import com.minbio.erp.utils.AppUtils
import org.json.JSONObject
import java.util.*
import kotlin.collections.ArrayList

class ProSupplierComplaintFragment : Fragment(), ResponseCallBack {
    ...
    private lateinit var complaintAdapter: ProSupplierComplaintAdapter

    private var complaintList: MutableList<ProSupplierComplaintData?> = ArrayList()
    ...
    private fun setAdapter() {
        ...
        complaintAdapter = ProSupplierComplaintAdapter(complaintList)
    ...
    private fun getComplaintData(c: Int) {
        ...
        val call = api.getProSupplierComplaint( c)
    ...
    private fun handleOrderResponse(jsonObject: JSONObject) {
        val gson = Gson()
        val model =
            gson.fromJson(jsonObject.toString(), ProSupplierComplaintModel::class.java)
