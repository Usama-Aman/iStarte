...
class ProSupplierComplaintAdapter(_complaintList: MutableList<ProSupplierComplaintData?>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    inner class Items(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(position: Int) {
            txt_lot_no.text = complaintList[position]?.order_no
            txt_comp_date.text = complaintList[position]?.date
            txt_supplier.text = complaintList[position]?.customer_name
    ...
    private inner class Progress(itemView: View) : RecyclerView.ViewHolder(itemView)
