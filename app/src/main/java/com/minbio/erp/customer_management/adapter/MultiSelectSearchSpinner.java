...
public class MultiSelectSearchSpinner  extends Dialog {
    ...
    private ArrayList<ComplaintItems> filteredList = new ArrayList<>();
    private ArrayList<ComplaintItems> unFilteredList = new ArrayList<>();
    ...
    public MultiSelectSearchSpinner(@NonNull Context context, ArrayList<ComplaintItems> strings) {
        super(context);
    ...
    private class ListAdapter extends BaseAdapter implements Filterable {
        ...
        public ListAdapter(Context c, ArrayList<ComplaintItems> list) {
            context = c;
            filteredList = list;
            unFilteredList = list;
            ...
            Filter filter = new Filter() {
                ...
                protected void publishResults(CharSequence constraint, FilterResults results) {
                    if (results.count == 0) {
                        ...
                        filteredList = (ArrayList<ComplaintItems>) results.values;
                ...
                protected FilterResults performFiltering(CharSequence charSequence) {
                    ...
                    if (charString.isEmpty()) {
                        ...
                        ArrayList<ComplaintItems> fl = new ArrayList<>();
                        for (ComplaintItems row : unFilteredList) {
