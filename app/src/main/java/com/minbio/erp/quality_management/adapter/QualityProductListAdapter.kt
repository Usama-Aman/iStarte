package com.minbio.erp.corporate_management.adapter
...
class QualityProductListAdapter(
    qma: QualityManagementFragment,
    _productList: MutableList<ProductListData?>
) : RecyclerView.Adapter<RecyclerView.ViewHolder>(), Filterable {


    private var qualityManagementFragment: QualityManagementFragment = qma
    ...
    inner class Items(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(position: Int) {
            ...
            if (expandedID != filteredProductList[position]?.id!!) {
                ...
                qualityManagementFragment.prodLotDetail(
                    detail_layout,
            ...
            btnExpand.setOnClickListener {
                ...
                expandedID = if (expandedID == filteredProductList[position]?.id!!)
                    -1
                else
                    filteredProductList[position]?.id!!
                notifyDataSetChanged()
            }

//            btnEditCustomer.setOnClickListener {
//                AppUtils.preventTwoClick(btnEditCustomer)
//                qualityManagementFragment.editProduct(filteredProductList[position]!!)
