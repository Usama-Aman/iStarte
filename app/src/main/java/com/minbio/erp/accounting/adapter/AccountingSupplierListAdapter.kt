...
import com.minbio.erp.accounting.fragments.AccountingSupplierList
import com.minbio.erp.supplier_management.models.SuppliersData
import de.hdodenhof.circleimageview.CircleImageView

class AccountingSupplierListAdapter(
    _accountingSupplierList: AccountingSupplierList,
    _suppliersList: MutableList<SuppliersData?>
) : RecyclerView.Adapter<RecyclerView.ViewHolder>(),Filterable {

    private val accountingSupplierList = _accountingSupplierList
    private var unfilteredData = _suppliersList
    private var filteredData = _suppliersList
    ...
    inner class Items(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(position: Int) {
            ...
            btnEditCustomer.setOnClickListener {
                accountingSupplierList.itemEdit(filteredData[position]!!.id)
