...
class TurnOverCollectedThirdPartyDialogSearch(
    context: Context,
    turnOverCollectedThirdPartyFragment: TurnOverCollectedThirdPartyFragment,
    _countriesModel: CountriesModel
) : Dialog(context) {

    private val fragment = turnOverCollectedThirdPartyFragment
