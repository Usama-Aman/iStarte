...
class InvoiceBoundSearchDialog(
    context: Context,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.dialog_financial_accounting_invoice_bound_search)
