...
class TurnOverInvoicedThirdPartyDialogSearch(
    turnOverInvoiceThirdPartyFragment: TurnOverInvoiceThirdPartyFragment,
    context: Context,
    _countriesModel: CountriesModel
) :
    Dialog(context) {

    private val fragment = turnOverInvoiceThirdPartyFragment
