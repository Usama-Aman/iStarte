...
class SalesLeftTabsAdapter(
    sa: SalesFragment,
    _productList: MutableList<ProductListData?>
) :
    RecyclerView.Adapter<RecyclerView.ViewHolder>() , Filterable {

    private var salesFragment: SalesFragment = sa
    private var filteredProductList = _productList
        ...
        fun bind(position: Int) {
            ...
            btnExpand.setOnClickListener {
                ...
                if (expandedID == filteredProductList[position]?.id!!)
                    ...
                    expandedID = filteredProductList[position]?.id!!
                notifyDataSetChanged()
            }

//            btnEditCustomer.setOnClickListener {
//                salesFragment.editProduct(filteredProductList[position]!!)
