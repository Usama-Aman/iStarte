...
class OrderPrepCustomerListAdapter(
    _orderPrepCustomerFragment: OrderPrepCustomerFragment,
    _customerOrderList: MutableList<CustomerOrderData?>
) : RecyclerView.Adapter<RecyclerView.ViewHolder>(), Filterable {

    private var orderPrepCustomerFragment = _orderPrepCustomerFragment

    private var filteredCustomerOrderList = _customerOrderList
    private var unfilteredCustomerOrderList = _customerOrderList
    ...
    inner class Items(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(position: Int) {
            ...
            if (expandedID != filteredCustomerOrderList[position]?.id!!) {
                ...
                orderPrepCustomerFragment.viewExpandDetails(
                    detail_layout,
    ...
    override fun getFilter(): Filter {
        return object : Filter() {
            override fun performFiltering(charSequence: CharSequence): FilterResults? {
                ...
                val filteredList: ArrayList<CustomerOrderData?> = ArrayList()
            ...
            override fun publishResults(
                ...
                if (filterResults != null) {
                    filteredCustomerOrderList =
                        filterResults.values as ArrayList<CustomerOrderData?>
                    notifyDataSetChanged()
                }
            }
        }
