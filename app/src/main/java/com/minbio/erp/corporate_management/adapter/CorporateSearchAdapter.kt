...
class CorporateSearchAdapter(
    cma: CorporateManagementFragment,
    _data: MutableList<CorporateUsersData?>
) : RecyclerView.Adapter<RecyclerView.ViewHolder>(), Filterable {

    private var corporateManagementActivity: CorporateManagementFragment = cma
    ...
    inner class Items(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(position: Int) {
            ...
            btnEditCustomer.setOnClickListener {
                try {
                    corporateManagementActivity.userClick(position, filteredData[position])
